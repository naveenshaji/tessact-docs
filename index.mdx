...
Licensing is subscription-based, metered by **seats \+ monthly agent-compute minutes**. Custom enterprise plans include SLA guarantees, dedicated support, and volume pricing.
...
<Check>
  You now have a high-level view of Tessact’s multi-agent architecture, value proposition, and deployment choices. Proceed to **Quick Start** to upload your first asset and trigger an agent workflow.
</Check>