...
![Tessact security group members page](/images/admin/admin-security-group-members-live-v2.jpg)
</Frame>
...
<Steps>
<Step title="Open a custom security group">
...
<Step title="Search and select the people to add">
  Click **Add members**, search the organization directory, and select the eligible people you want to add to the cohort.
  <Frame caption="Add-members modal inside a custom security group">
    ![Add members to security group modal](/images/admin/admin-security-group-add-members-live-v2.jpg)
  </Frame>
</Step>
<Step title="Submit and review the refreshed member list">
