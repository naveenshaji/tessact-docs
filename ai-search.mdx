...
3. **Clip carving** – Tessact auto-selects a start and end that form a coherent narrative unit (≈ 1–3 min) with clean audio transitions.  
...
| **Add to timeline** `E` | Inside Tessact Editor | Inserts clip at playhead, retaining in/out points. |
