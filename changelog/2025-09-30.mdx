...
<Steps>
  <Step title="Create a draft or open an existing one">
    Start a new **Draft** from the **Library** and add your video to the
    timeline, or open an existing one.
  </Step>
  <Step title="Mark In/Out points">
    Use <kbd>I</kbd> and <kbd>O</kbd> to set start and end for the segment you
    want to export.
    <Frame caption="Segment marked in the timeline">
      ![Selective rendering in
      editor](/images/changelog/2025-09-30/selective-timeline-rendering.jpg)
    </Frame>
    <Info>
  ...
  <Step title="Render the selection">
    ...
    <Frame caption="Render button on the action bar with the selected time">
      ![Render button on the action
      bar](/images/changelog/2025-09-30/render-button.jpg)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Select a clip on the timeline">
    Select a clip on the timeline and open the **Properties** panel, go to the
    **Subtitles** tab. Generate auto-subtitles if not already enabled.
    <Frame caption="Subtitles tab in the Properties panel">
      ![Subtitles tab in the Properties
      panel](/images/changelog/2025-09-30/subtitle-panel.jpg)
    </Frame>
  </Step>
  <Step title="Scroll down to edit captions">
    ...
    <Frame caption="Time-stamped captions in the Properties panel">
      ![Time-stamped captions in the Properties
      panel](/images/changelog/2025-09-30/subtitle-edit.jpg)
    </Frame>
  </Step>
  <Step title="Render with updates">
    Save your changes to apply updated subtitles to your draft. This will
    reflect in any renders as well.
  </Step>
</Steps>
