...
<Steps>
  ...
  <Step title="Mark In/Out points">
    ...
    <Frame caption="Segment marked in the timeline">
        ![Selective rendering in editor](/images/changelog/2025-09-30/selective-timeline-rendering.jpg)
    </Frame>
    <Info>
  ...
  <Step title="Render the selection">
    ...
    <Frame caption="Render button on the action bar with the selected time">
        ![Render button on the action bar](/images/changelog/2025-09-30/render-button.jpg)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Select a clip on the timeline">
    ...
    <Frame caption="Subtitles tab in the Properties panel">
        ![Subtitles tab in the Properties panel](/images/changelog/2025-09-30/subtitle-panel.jpg)
    </Frame>
  </Step>
  <Step title="Scroll down to edit captions">
    ...
    <Frame caption="Time-stamped captions in the Properties panel">
        ![Time-stamped captions in the Properties panel](/images/changelog/2025-09-30/subtitle-edit.jpg)
    </Frame>
  </Step>
