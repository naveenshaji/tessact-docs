...
After you create a **Connection** in **Settings → Connections**, you can mount one or more **Connected Folders** in the Library. Each folder maps 1-for-1 to an entire bucket and stays in continuous sync.
