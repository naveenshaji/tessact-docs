...
<Warning>
  The invitation link expires after **24 hours**. If it lapses, use Login with OTP on the login page instead.
</Warning>
...
<Info>
  To customise fields or enforce naming standards, create Metadata Templates in **Settings → Metadata**. See the Metadata Guide for details.
</Info>
