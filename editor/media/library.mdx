...
Library exposes media from the draft's active workspace inside the editor. Use it to bring existing workspace assets into your video draft without leaving the editing surface. The screenshots use **Wayanad — A Quiet Journey** as the worked example.

<Frame caption="Wayanad media available in the editor Library modal">
  <img src="/images/editor/screenshots/editor-media-library-wayanad.png" alt="Library modal showing realistic Wayanad media assets" />
</Frame>
...
<Frame caption="A Library asset selected before insertion">
  <img src="/images/editor/screenshots/editor-media-library-wayanad-selection.png" alt="Selected Wayanad asset in the Tessact Library modal" />
</Frame>
