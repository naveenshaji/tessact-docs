...
For the Wayanad title card, place title and location text in a column frame, use a small gap, center cross-axis alignment, and symmetrical padding. Text changes then reflow without manually recalculating the stack.
