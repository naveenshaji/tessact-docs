...
<Frame caption="Starting the H.264 render for Wayanad">
  <img src="/images/editor/screenshots/editor-render-starting.png" alt="Wayanad editor with Render video entering the Starting state" />
</Frame>
